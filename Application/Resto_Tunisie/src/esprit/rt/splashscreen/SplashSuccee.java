...
public class SplashSuccee extends Canvas implements Runnable {

    private final Resto_Tunisie midlet;
    private Image splashImage;
    private volatile boolean dismissed = false;

    public SplashSuccee(Resto_Tunisie midlet) throws InterruptedException {
        this.midlet = midlet;
        setFullScreenMode(true);
        splashImage = Resto_Tunisie.createImage("/esprit/rt/image/Winning.jpg");
