...
public class MenuGet1 implements Runnable {

    StringBuffer sb = new StringBuffer();

    Menu[] menu;
    public String[] items = {"Select Menu"};
    public ChoiceGroup ch5 = new ChoiceGroup("", List.POPUP, items, null);
    ...
    public void run() {
        try {
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/PIDevJ2ME/getXmlMenu1.php");
